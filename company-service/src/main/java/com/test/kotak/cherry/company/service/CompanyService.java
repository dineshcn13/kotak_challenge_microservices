...
public class CompanyService {
	...
	public Company updateCompanyByCompanyId(Company company) {
	 ...
	 public ResponseData getEmployeeWithCompany(Long companyId) {
	        ...
	        List<Employee> employee = employeeServiceProxy.findEmployeeByCompanyId(company.getCompanyId());
	...
	public String getHelloWorld() {
		log.info("Inside getHelloWorld of CompanyService");
		return employeeServiceProxy.getEmployeeCall();
	}
}
